...
public class GatePassRequestController {
    ...
    public ResponseEntity<Map<String, Object>> approveByStaff(
        ...
        try {
            GatePassRequest request = gatePassRequestService.approveByStaff(requestId, staffCode);
    ...
    public ResponseEntity<Map<String, Object>> approveByHod(
        ...
        try {
            GatePassRequest request = gatePassRequestService.approveByHOD(requestId, hodCode);
